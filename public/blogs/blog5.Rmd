...
ggplot(summ_monthly_returns_plot, aes(x = monthly_returns, color = symbol, fill=symbol))+ geom_density() +labs( x = " Returns", y = " Density")+facet_grid(rows = "symbol", scales = "free_y")
...
myStocks_returns_monthly %>% 
  tq_performance(Ra = monthly_returns, #the name of the variable containing the returns of the asset
                 Rb = NULL, 
